      ...
      <div className="policy-content">
        ...
        <ul>
          ...
          <li>
            ...
            "Us" or "Our" in this Agreement) refers to Designaigence Innovations
            Private Limited, E-74, Mansa Ram Park, Uttam Nagar, New Delhi, 110
            059.
          </li>
          <li>
          ...
          <li>
            <strong>Website</strong> refers to DeepShape, accessible from{" "}
            <a href="https://www.deepshape.tech/">
              https://www.deepshape.tech/
            </a>
          </li>
          <li>
        ...
        <ul>
          <li>
            ...
            <a href="https://www.deepshape.tech/contact">
              https://www.deepshape.tech/contact
            </a>
          </li>
        </ul>
      </div>
